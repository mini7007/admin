...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-gradient-black">
       ...
       <!-- <img src= uploads/logo-1641866302.png alt="Store Logo" class="brand-image img-circle elevation-3 bg-black" style="width: 1.8rem;height: 1.8rem;max-height: unset;object-fit:scale-down;object-position:center center"> -->
        <span class="brand-text font-weight-light">Dr.Daspathlab</span>
        </a>
        <!-- Sidebar -->
